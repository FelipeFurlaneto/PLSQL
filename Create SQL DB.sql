...
/*
FASE 3 - 1.3 Desafio 1: Criar um bloco anônimo em Oracle PL/SQL para a empresa Melhores Compras
1.3 Desafio 1: Criar um bloco anônimo em Oracle PL/SQL para a empresa Melhores Compras
 Crie um cursor nomeado que exiba as seguintes informações:
*/

-- Dados significativos para MC_SGV_OCORRENCIA_SAC

INSERT INTO MC_SGV_SAC(NR_SAC, NR_CLIENTE, CD_PRODUTO, CD_FUNCIONARIO, DS_DETALHADA_SAC,
DT_ABERTURA_SAC, HR_ABERTURA_SAC, TP_SAC, ST_SAC)
VALUES (SQ_MC_SGV_SAC.NEXTVAL, 12, 14, 5, 'Notebook chegou, mas com atraso de 4 dias úteis', sysdate-1, 14, 'S', 'E');

INSERT INTO MC_SGV_SAC(NR_SAC, NR_CLIENTE, CD_PRODUTO, CD_FUNCIONARIO, DS_DETALHADA_SAC,
DT_ABERTURA_SAC, HR_ABERTURA_SAC, TP_SAC, ST_SAC)
VALUES (SQ_MC_SGV_SAC.NEXTVAL, 1, 2, 6, 'Fone top d+, escutando Mozart como nunca!', sysdate-1, 14, 'E', 'E');

INSERT INTO MC_SGV_SAC(NR_SAC, NR_CLIENTE, CD_PRODUTO, CD_FUNCIONARIO, DS_DETALHADA_SAC,
DT_ABERTURA_SAC, HR_ABERTURA_SAC, TP_SAC, ST_SAC)
VALUES (SQ_MC_SGV_SAC.NEXTVAL, 4, 2, 3, 'Excelente para escutar um bom funk', sysdate-1, 14, 'E', 'E');

INSERT INTO MC_SGV_SAC(NR_SAC, NR_CLIENTE, CD_PRODUTO, CD_FUNCIONARIO, DS_DETALHADA_SAC,
DT_ABERTURA_SAC, HR_ABERTURA_SAC, TP_SAC, ST_SAC)
VALUES (SQ_MC_SGV_SAC.NEXTVAL, 10, 21, 4, 'Cheiroso, nunca mais tive que lavar minha casa', sysdate-1, 14, 'E', 'E');

INSERT INTO MC_SGV_SAC(NR_SAC, NR_CLIENTE, CD_PRODUTO, CD_FUNCIONARIO, DS_DETALHADA_SAC,
DT_ABERTURA_SAC, HR_ABERTURA_SAC, TP_SAC, ST_SAC)
VALUES (SQ_MC_SGV_SAC.NEXTVAL, 7, 19, 7, 'Ração gostosa, adotei para minha dieta também', sysdate-1, 14, 'E', 'E');
